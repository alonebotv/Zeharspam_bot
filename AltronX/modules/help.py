...
async def help(event):
    if event.sender_id in SUDO_USERS:
       await event.client.send_file(event.chat_id,
                                  "https://te.legra.ph/file/6a817381d251ba2ebe228.jpg",
                                  caption=PythonHelp,
                                  buttons=[
           [
           ...
           [    
            Button.url("• ᴄʜᴀɴɴᴇʟ •", "https://t.me/zehar_dpz"),
            Button.url("• sᴜᴘᴘᴏʀᴛ •", "https://t.me/touch_your_heart31")
           ],
           ],
           )
...
async def helpback(event):
   if event.query.user_id in SUDO_USERS:    
      await event.edit(
        ...
        await event.answer("Make Your Own Tosu Bots !! @zehar3_bot", cache_time=0, alert=True)
